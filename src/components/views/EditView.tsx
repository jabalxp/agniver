...
import { Calendar, User, AlignLeft, Palette, Save, Phone, ArrowLeft } from 'lucide-react'
...
export function EditView() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (editingId) {
      await updateBirthday(editingId, formData)
      setEditingId(null)
  ...
  return (
    <ViewLayout 
      ...
      subtitle={`Editando as informações de ${formData.name}`}
    >
      <div className="mb-6">
        <button 
          onClick={() => {
